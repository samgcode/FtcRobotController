...
public class OdometryCalibration extends LinearOpMode {
    ...
    String rfName = "drive3", rbName = "drive0", lfName = "drive1", lbName = "drive2";
    ...
    final double COUNTS_PER_INCH = 1/TICKS_TO_INCHES;
    ...
    public void runOpMode() throws InterruptedException {
       ...
       */
        ...
        while(opModeIsActive()){
            ...
            telemetry.addData("Horizontal Encoder Offset per radian", horizontalTickOffset);
            telemetry.addData("Horizontal Encoder Offset", horizontalTickOffset/COUNTS_PER_INCH*4);
...
//            telemetry.addData("Horizontal Position", horizontal.getCurrentPosition());
            telemetry.addData("Vertical Encoder Offset per degree", verticalEncoderTickOffsetPerDegree);
